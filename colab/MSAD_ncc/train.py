...
Original file is located at
    https://colab.research.google.com/drive/1uFJD9CCjeTPXMVLALSl8W7P0Uhj1UID5
"""
...
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD_ncc/stage1"
...
#   --init-weights "$KATVAD_OUTPUT_ROOT/MSAD_ncc/stage1/checkpoint_last.pt" \
#   --data-dir "$KATVAD_DATA_ROOT/MSAD" \
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD_ncc" \
#   --flow-dir "$KATVAD_CACHE_ROOT/flow/v1/MSAD/MSAD-full" \
#   --knn-cache "$KATVAD_CACHE_ROOT/knn/MSAD_ncc/knn_cache.npz" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD_ncc/stage2_kip_on"
...
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD_ncc" \
#   --knn-cache "$KATVAD_CACHE_ROOT/knn/MSAD_ncc/knn_cache.npz" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD_ncc/stage2_kip_off"
...
#   --ckpt "$KATVAD_OUTPUT_ROOT/MSAD_ncc/stage2_kip_off/checkpoint_last.pt" \
#   --set kip.enabled=false --set data.dataset=MSAD-full \
#   --data-dir "$KATVAD_DATA_ROOT/MSAD" \
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD_ncc" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD_ncc/eval_kip_off" \
#   --save-scores
...
# 
# python -m core.evaluate \
#   --ckpt "$KATVAD_OUTPUT_ROOT/MSAD_ncc/stage2_kip_on/checkpoint_last.pt" \
#   --set data.dataset=MSAD-full \
#   --data-dir "$KATVAD_DATA_ROOT/MSAD" \
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD_ncc" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD_ncc/eval_kip_on" \
#   --save-scores

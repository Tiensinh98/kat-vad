...
Data dir: `/content/d0/dataset/d0_frac` · score head kernel **9** · MIL top-k pct **16** · sections: features
...
|---|---|---|---|
| **INFO** | The features DO carry a frame-level signal | Supervised linear probe reaches auc_macro 0.6518 on the same cached features the trained arms saw. | The deficit is SUPERVISION, not representation. A better head or denser labels can close it; a different backbone is not required. |
...
|---|---:|---:|---:|---:|---:|---:|
| frame-level | 0.6207 | 0.6518 | 0.4169 | 0.3079 | 5 | 15,961 frames |

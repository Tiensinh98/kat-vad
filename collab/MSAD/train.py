...
Original file is located at
    https://colab.research.google.com/drive/1GMf52hLcYqvSYziyj94uWe6nYHsvk3N6
"""
...
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/stage1"
...
#   --init-weights "$KATVAD_OUTPUT_ROOT/MSAD/stage1/checkpoint_last.pt" \
#   --data-dir "$KATVAD_DATA_ROOT/MSAD" \
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD" \
#   --flow-dir "$KATVAD_CACHE_ROOT/flow/v1/MSAD/MSAD-full" \
#   --knn-cache "$KATVAD_CACHE_ROOT/knn/MSAD/knn_cache.npz" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/stage2_kip_on"
...
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD" \
#   --knn-cache "$KATVAD_CACHE_ROOT/knn/MSAD/knn_cache.npz" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/stage2_kip_off"
...
#   --data-dir "$KATVAD_DATA_ROOT/MSAD" \
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/eval_kip_off" \
#   --save-scores
...
#   --data-dir "$KATVAD_DATA_ROOT/MSAD" \
#   --clip-dir "$KATVAD_CACHE_ROOT/clip/MSAD" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/eval_kip_on" \
#   --save-scores
...
#   --scores "$KATVAD_OUTPUT_ROOT/MSAD/eval_kip_off/scores" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/eval_kip_off/plots"
...
# 
# python -m core.tools.visualize \
#   --scores "$KATVAD_OUTPUT_ROOT/MSAD/eval_kip_on/scores" \
#   --output-dir "$KATVAD_OUTPUT_ROOT/MSAD/eval_kip_on/plots"
...
res = {k: json.load(open(f'{out}/MSAD/eval_kip_{k}/results.json'))['per_video']
       for k in ('off', 'on')}
